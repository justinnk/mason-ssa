...
public class PredatorPreyModelWithUI extends GUIState {
	...
	public void setupPortrayals() {
		...
		ChartUtilities.scheduleSeries(this, sheepSeries, new Valuable() {
			@Override
			public double doubleValue() {
				return model.getNumSheep();
			}
		});
		ChartUtilities.scheduleSeries(this, wolfSeries, new Valuable() {
			@Override
			public double doubleValue() {
	...
	public void init(Controller c) {
		...
		ecoSeries = ChartUtilities.buildTimeSeriesChartGenerator(this, "Ecosystem Populations", "number");
