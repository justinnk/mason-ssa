...
public class SirsModelWithUI extends GUIState {
	...
	public void setupPortrayals() {
		...
		worldPortrayal.setPortrayalForAll(new LabelledPortrayal2D(new OvalPortrayal2D(2.0) {
		...
		ChartUtilities.scheduleSeries(this, infectionSeries, new Valuable() {
			@Override
			public double doubleValue() {
				return model.getNumInfected();
			}
		});
		ChartUtilities.scheduleSeries(this, recoverySeries, new Valuable() {
			@Override
			public double doubleValue() {
				return model.getNumRecovered();
			}
		});
		ChartUtilities.scheduleSeries(this, susceptibleSeries, new Valuable() {
			@Override
			public double doubleValue() {
	...
	public void init(Controller c) {
		...
		SIRSeries = ChartUtilities.buildTimeSeriesChartGenerator(this, "Infection curves", "number of people");
