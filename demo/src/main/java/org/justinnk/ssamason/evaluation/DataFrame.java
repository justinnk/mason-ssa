...
public class DataFrame {
	...
	/**
	 * Computes a function on an existing value at the index of the given column (or
	 * null, if there is no value associated with the index).
	 */
	...
	/**
	 * Computes a function on an existing value at the index of all columns (or
	 * null, if there is no value associated with the index).
	 */
	...
	/**
	 * Adds an entry to the provided column. If there is no column with this name,
	 * it will be created.
	 */
	...
	/**
	 * Appends all of data to the matching columns in this frame. Non-existing
	 * columns are copied as they are to this frame.
	 */
